...
//	public static final String name = "商品类型-李咏版";
    ...
    $wnd.getAttrList = function (id) {
        me.@com.jcommerce.gwt.client.panels.leontest.GoodsTypeListPanel::getAttrList(Ljava/lang/String;)(id);
    };
    
    $wnd.editGoodsType = function (id) {
        me.@com.jcommerce.gwt.client.panels.leontest.GoodsTypeListPanel::editGoodsType(Ljava/lang/String;)(id);
    };
    }-*/;
...
//		newState.execute();
		...
		GoodsTypePanel2.State newState = new GoodsTypePanel2.State();
		newState.setIsEdit(false);
		newState.execute();
	}
