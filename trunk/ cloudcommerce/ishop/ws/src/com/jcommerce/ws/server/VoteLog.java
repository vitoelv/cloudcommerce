 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.util.Date localVoteTime ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localVoteTimeTracker = false ;
                           ...
                           */
                           public  java.util.Date getVoteTime(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param VoteTime
                               */
                               public void setVoteTime(java.util.Date param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localVoteTimeTracker = true;
                                       } else {
                                          localVoteTimeTracker = false;
                                              
                                       }
                                   
                                            this.localVoteTime=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       VoteLog.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localVote));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://ws.jcommerce.com/",
                                        ...
                                        if (localVoteTime != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localVoteTime));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("voteTime cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static VoteLog parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VoteLog object =
                new VoteLog();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"VoteLog".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (VoteLog)com.jcommerce.ws.server.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.jcommerce.com/","voteTime").equals(reader.getName())){
