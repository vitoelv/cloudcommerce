        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.jcommerce.ws.server.QueryOperator localOperator ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.jcommerce.ws.server.QueryOperator
                           */
                           public  com.jcommerce.ws.server.QueryOperator getOperator(){
                            ...
                            /**
                               ...
                               */
                               public void setOperator(com.jcommerce.ws.server.QueryOperator param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QueryCondition",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QueryCondition",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localOperator.serialize(new javax.xml.namespace.QName("http://ws.jcommerce.com/","operator"),
                                               factory,xmlWriter);
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QueryCondition".equals(type)){
                                ...
                                return (QueryCondition)com.jcommerce.ws.server.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.jcommerce.com/","operator").equals(reader.getName())){
                                
                                                object.setOperator(com.jcommerce.ws.server.QueryOperator.Factory.parse(reader));
