 ...
 */
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                           ...
                           */
                           public  int getLinkGoods(){
                            ...
                            /**
                               ...
                               */
                               public void setLinkGoods(int param){
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localBidirectionalTracker = false ;
                               ...
                               */
                               public void setBidirectional(boolean param){
                                       ...
                                       // setting primitive attribute tracker to true
                                               ...
                                               if (false) {
                                           localBidirectionalTracker = false;
                                              
                                       } else {
                                          localBidirectionalTracker = true;
                                       }
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       LinkGoods.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localIdTracker){
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLinkGoods));
                            } if (localBidirectionalTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://ws.jcommerce.com/",
                                                                      "bidirectional"));
    ...
    public static class Factory{
        ...
        */
        public static LinkGoods parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LinkGoods object =
                new LinkGoods();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LinkGoods".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LinkGoods)com.jcommerce.ws.server.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                                    ...
                                    java.lang.String content = reader.getElementText();
                                        ...
                                        reader.next();
                                               ...
                                               object.setLinkGoods(java.lang.Integer.MIN_VALUE);
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.jcommerce.com/","bidirectional").equals(reader.getName())){
