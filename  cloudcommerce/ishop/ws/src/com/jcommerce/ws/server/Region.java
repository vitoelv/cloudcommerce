 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected int[] localAreas ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAreasTracker = false ;
                           ...
                           */
                           public  int[] getAreas(){
                              ...
                              /**
                               * validate the array for Areas
                               */
                              protected void validateAreas(int[] param){
                              ...
                              * @param param Areas
                              */
                              public void setAreas(int[] param){
                                   ...
                                   validateAreas(param);
                                          ...
                                          if (param != null){
                                             //update the setting tracker
                                             localAreasTracker = true;
                                          } else {
                                             localAreasTracker = false;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Region.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                            ...
                            if (localAreas!=null){
                                  for (int i = 0;i < localAreas.length;i++){
                                          ...
                                          elementList.add(new javax.xml.namespace.QName("http://ws.jcommerce.com/",
                                                                                                                       "areas"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAreas[i]));
    ...
    public static class Factory{
        ...
        */
        public static Region parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Region object =
                new Region();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Region".equals(type)){
                                ...
                                return (Region)com.jcommerce.ws.server.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list7 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.jcommerce.com/","areas").equals(reader.getName())){
                                    ...
                                    list7.add(reader.getElementText());
                                            ...
                                            while(!loopDone7){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://ws.jcommerce.com/","areas").equals(reader.getName())){
                                                         list7.add(reader.getElementText());
