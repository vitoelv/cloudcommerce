...
public class GoodsList extends ContentWidget {
...
//    	wantedFields.add(IGoods.NUMBER);
		...
		panel.addButton(new Button(Resources.constants.GoodsList_add_new(),
				new SelectionListener<ButtonEvent>() {
					public void componentSelected(ButtonEvent ce) {
						iShop.getInstance().displayGoodsPanel(null);
					}
				}));
	...
	private native void initJS(GoodsList me) /*-{
	   $wnd.deleteGoods = function (id) {
	       me.@com.jcommerce.gwt.client.panels.GoodsList::deleteGoodsAndRefrsh(Ljava/lang/String;)(id);
	   };
	   $wnd.editGoods = function (id) {
	       me.@com.jcommerce.gwt.client.panels.GoodsList::editGoods(Ljava/lang/String;)(id);
	   };
	   }-*/;
		...
		new ReadService().getBean(ModelNames.GOODS, id,
				new ReadService.Listener() {
					public void onSuccess(BeanObject bean) {
						iShop.getInstance().displayGoodsPanel(bean);
					}
				});
	}
