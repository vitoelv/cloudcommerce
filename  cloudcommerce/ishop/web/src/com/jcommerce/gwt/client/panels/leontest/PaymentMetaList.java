...
public class PaymentMetaList extends ContentWidget {
    ...
    private native void initJS(PaymentMetaList me) /*-{
       $wnd.installPayment = function (code) {
           me.@com.jcommerce.gwt.client.panels.leontest.PaymentMetaList::installPayment(Ljava/lang/String;)(code);
       };
       $wnd.editPayment = function (id) {
           me.@com.jcommerce.gwt.client.panels.leontest.PaymentMetaList::editPayment(I)(id);
       };
       $wnd.uninstallPayment = function (id) {
           me.@com.jcommerce.gwt.client.panels.leontest.PaymentMetaList::uninstallPayment(I)(id);
       };
       }-*/;
...
//        toolBar.bind(loader);
        ...
        columns.add(col);
        columns.add(new ColumnConfig(PaymentConfigMetaForm.DESC, Resources.constants
                .PaymentMetaList_DESC(), 200));
        columns.add(new ColumnConfig(PaymentConfigMetaForm.PAYFEE, Resources.constants
                .PaymentMetaList_PAYFEE(), 50));
        columns.add(new ColumnConfig(PaymentConfigMetaForm.ISCOD, Resources.constants
